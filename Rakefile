...
desc 'Generate documentation for the postcode_zones extension.'
Rake::RDocTask.new(:rdoc) do |rdoc|
  rdoc.rdoc_dir = 'rdoc'
  rdoc.title    = 'PostcodeZonesExtension'
...
desc 'Test the postcode_zones extension.'
...
namespace :test do
  desc 'Functional test the postcode_zones extension.'
  ...
  desc 'Unit test the postcode_zones extension.'
